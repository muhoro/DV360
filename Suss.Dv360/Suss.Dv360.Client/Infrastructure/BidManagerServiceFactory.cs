...
/// <summary>
/// Thread-safe factory that creates and caches an authenticated <see cref="DoubleClickBidManagerService"/>.
/// <para>
...
internal sealed class BidManagerServiceFactory(
    IDv360AuthProvider authProvider,
    IOptions<Dv360ClientOptions> options) : IBidManagerServiceFactory
{
    ...
    private DoubleClickBidManagerService? _cachedService;

    /// <inheritdoc />
    public async Task<DoubleClickBidManagerService> CreateAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            _cachedService = new DoubleClickBidManagerService(initializer);
            return _cachedService;
        }
        finally
        {
